...
$(document).ready(function () {
    ...
    //---- CODE ----
    //---- Aqui va el script que se encuentra en home.xhtml
    ...
    var $plusDetails = $('<div class="plus-details">\
                                        <ul >\
                                            ...
                                            <li><a href="#"><i class="cvicon-cv-playlist" aria-hidden="true"></i> Agregar a mi Lista</a></li>\
                                        </ul>\
                                    </div>');
        ...
        setUpListeners: function () {
            ...
            $('.btn-color-toggle').on('click', function () {
                if ($('body').hasClass('light')) {
                    ...
                    $(this).find('img').attr('src', '../../resources/images/icon_bulb_dark.png');
                } else {
                    if ($('body').hasClass('dark'))
                        $('body').removeClass('dark').addClass('light');
                    $(this).find('img').attr('src', '../../resources/images/icon_bulb_light.png');
                }
            });
